...
@stub.function()
def interpret_code(user_code, test_cases): # should take the users code and test cases generated by groq
    exec_globals = {}

    try:
        exec(user_code, exec_globals) # running the code and putting the results in exec_globals
        user_func = exec_globals.get("user_function") # getting the user function from the code
        ...
        for test_case in test_cases:
            try:
                ...
                results.append(result == test_case["output"]) # checks if the output is correct and adds it to the results
